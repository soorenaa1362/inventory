        ...
        <div class="card collapse-icon accordion-icon-rotate"
            ...
            <div id="heading10" class="card-header"
                ...
                <a data-toggle="collapse" href="" data-target="#accordion10"
                    ...
                    style="color:#FFFFFF;font-weight: 100">فرم ثبت مشتری</a>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                                        ...
                                        <fieldset class="form-group">
                                            <label for="disabledInput">نام مشتری</label>
                                            <input type="text"
                                        ...
                                        @foreach ($customers as $key => $customer)
                                            <tr role="row" class="odd">
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <a href = "{{route('CustomerDestroy' , [$customer->id])}}"
                                                        onclick="return confirm('آیا تمایل به حذف این مشتری دارید ؟');"
                                                        class="btn btn-sm

        ...
        <div class="card collapse-icon accordion-icon-rotate"
            ...
            <div id="heading2" class="card-header"
                ...
                <a data-toggle="collapse" href="" data-target="#accordion2"
                    ...
                    style="color:#FFFFFF;font-weight: 100">فرم ثبت ورودی (قطعات تولید شده)
                </a>
            </div>
                ...
                <div class="card-body" style="padding: 15px">
                    <div class="px-3">
                        <form class="form" method="POST" 
                            action="{{route('ContractorInputPieceStore' , [$contractorContract->id])}}">
                            @csrf
                            <input type="hidden" name="id" value="{{$inputPiece->id ?? ''}}">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <label>تاریخ</label>
                                            <input type="text" 
                                                class="form-control @error('date_input_piece') is-invalid @enderror" round addpo"
                                                id="dateOfInputPiece"
                                                name="dateOfInputPiece" readonly
                                                required
                                                value = "{{(isset($inputPiece)) ? $inputPiece->getdateJalali() : ''}}">
                                            <input id="date_input_piece" name="date_input_piece" type="hidden"
                                                value = "{{(isset($inputPiece)) ? $inputPiece->getdateTimestamp() : ''}}">
                                        </div>
                                    </div>  
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" 
                                                    ...
                                                    name="weight" value="{{$inputPiece->weight ?? ''}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" 
                                                    ...
                                                    name="number" value="{{$inputPiece->number ?? ''}}">
                                                <div class="input-group-prepend">
                        ...
                        <div class="row" style="padding-top: 10px">
                            <div class="col-md-12" style="text-align: center;">
                                <table class="table table-striped
                                    ...
                                    <tbody>
                                        @foreach ($contractorInputPieces as $key => $contractorInputPiece)
                                            <tr role="row" class="odd">
                                                ...
                                                <td style="text-align: center;">
                                                    {{$contractorInputPiece->weight}}
                                                </td> 
                                                <td style="text-align: center;">
                                                    {{$contractorInputPiece->number}}
                                                </td>                                            
                                                <td style="text-align: center;">
                                                    <a href = "{{route('ContractorInputPieceEdit' , [$contractorInputPiece->id])}}"
                                                        class="btn btn-sm
                                                        btn-outline-info round mb-0" >
                                                        ویرایش
                                                    </a>
                                                        <a href = "{{route('ContractorInputPieceDestroy' , [$contractorInputPiece->id])}}"
                                                        onclick="return confirm('آیا تمایل به حذف این مورد دارید ؟');"
                                                        class="btn btn-sm

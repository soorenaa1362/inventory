                ...
                <div class="card-body" style="padding: 15px">
                    <div class="px-3">
                        <form class="form" method="POST" 
                            action="{{route('ContractorInputRawMaterialStore' , [$contractorContract->id])}}">
                            @csrf
                        ...
                        <div class="row" style="padding-top: 10px">
                            <div class="col-md-12" style="text-align: center;">
                                <table class="table table-striped
                                    ...
                                    <tbody>
                                        @foreach ($contractorInputRawMaterials as $key => $contractorInputRawMaterial)
                                            <tr role="row" class="odd">
                                                ...
                                                <td style="text-align: center;">
                                                    {{$contractorInputRawMaterial->weight}}
                                                </td> 
                                                <td style="text-align: center;">
                                                    {{$contractorInputRawMaterial->RawMaterial->name}}
                                                </td>                                            
                                                <td style="text-align: center;">
                                                    <a href = "{{route('ContractorInputRawMaterialEdit' , [$contractorInputRawMaterial->id])}}"
                                                        class="btn btn-sm
                                                        btn-outline-info round mb-0" >
                                                        ویرایش
                                                    </a>
                                                    <a href = "{{route('ContractorInputRawMaterialDestroy' , [$contractorInputRawMaterial->id])}}"

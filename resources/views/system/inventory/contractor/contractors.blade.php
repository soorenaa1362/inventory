        ...
        <div class="card collapse-icon accordion-icon-rotate"
            ...
            <div id="heading10" class="card-header"
                ...
                <a data-toggle="collapse" href="" data-target="#accordion10"
                    ...
                    style="color:#FFFFFF;font-weight: 100">فرم ثبت پیمانکار</a>
            </div>
                        ...
                        <form class="form" method="post"
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="fk_repository" 
                                                    class="form-control @error('fk_repository') is-invalid @enderror"
                                                    value="{{$contractor->fk_repository ?? ''}}">
                                                    @foreach ($repositories as $repository)
                                                        <option value="{{$repository->id}}"
                                                            {{ ((isset($contractor)) &&
                                                                $contractor->repository->id == $repository->id) 
                                                                ?
                                                                    ' selected=""'
                                                                :
                                                                    '' 
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-12 mb-1">
                                        <fieldset class="form-group">
                                            <label for="disabledInput">تلفن ثابت</label>
                                            <input type="text"
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-12 mb-1">
                                        <fieldset class="form-group">
                                            <label for="disabledInput">تلفن همراه</label>
                                            <input type="text"
...
<!-- End Col lg 12 -->
<!-- Create Contractor : End -->

<!-- List Contractor : Start -->
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <div class="card-title-wrap bar-success">
                <div class="row">
                    <div class="col-md-9">
                        <h4 class="card-title">لیست پیمانکاران</h4>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($contractors as $key => $contractor)
                                            <tr role="row" class="odd">
                                                ...
                                                <td style="text-align: center;">
                                                    <a href=
                                                        "{{route('ContractorEdit' , [$contractor->id])}}"
                                                        class="btn btn-sm
                                                        btn-outline-info round mb-0" >
                                                        ویرایش
                                                    </a>
                                                    <a href=
                                                        "{{route('ContractorDestroy' , [$contractor->id])}}"
                                                        onclick="return confirm('آیا تمایل به حذف این پیمانکار دارید ؟');"
                                                        class="btn btn-sm
